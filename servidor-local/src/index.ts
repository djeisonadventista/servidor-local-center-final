...
app.use(cors({
    origin: ["http://localhost:3000", "https://servidor-local-center-final-bm2r.onrender.com", "dev-servidor-local-center-final.vercel.app", "servidor-local-center-final-pied.vercel.app"],
    credentials: true,
