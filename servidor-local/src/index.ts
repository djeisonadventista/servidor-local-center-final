...
app.use(cors({
    origin: ["http://localhost:3000", "https://servidor-local-center-final-bm2r.onrender.com", "https://dev-servidor-local-center-final.vercel.app", "https://servidor-local-center-final-pied.vercel.app"],
    credentials: true,
